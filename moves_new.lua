...
return {
  ACIDSPRAY = { name = "Acid Spray", type = "POISON", category = "special", power = 40, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef2" },
  ...
  ANCIENTPOWER = { name = "Ancient Power", type = "ROCK", category = "special", power = 60, accuracy = 100, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserMainStats1" },
  APPLEACID = { name = "Apple Acid", type = "GRASS", category = "special", power = 80, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef1" },
  ...
  AROMATICMIST = { name = "Aromatic Mist", type = "FAIRY", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseTargetSpDef1" },
  ...
  ATTRACT = { name = "Attract", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "AttractTarget" },
  ...
  BOUNCE = { name = "Bounce", type = "FLYING", category = "physical", power = 85, accuracy = 85, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "TwoTurnAttackInvulnerableInSkyParalyzeTarget" },
  ...
  BRAVEBIRD = { name = "Brave Bird", type = "FLYING", category = "physical", power = 120, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RecoilThirdOfDamageDealt" },
  BREAKINGSWIPE = { name = "Breaking Swipe", type = "DRAGON", category = "physical", power = 60, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAttack1" },
  ...
  BUGBUZZ = { name = "Bug Buzz", type = "BUG", category = "special", power = 90, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef1" },
  BULKUP = { name = "Bulk Up", type = "FIGHTING", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAtkDef1" },
  BULLDOZE = { name = "Bulldoze", type = "GROUND", category = "physical", power = 60, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpeed1WeakerInGrassyTerrain" },
  ...
  CALMMIND = { name = "Calm Mind", type = "PSYCHIC", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserSpAtkSpDef1" },
  CHARGE = { name = "Charge", type = "ELECTRIC", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserSpDef1PowerUpElectricMove" },
  CHARM = { name = "Charm", type = "FAIRY", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAttack2" },
  CLEARSMOG = { name = "Clear Smog", type = "POISON", category = "special", power = 50, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "ResetTargetStatStages" },
  CLOSECOMBAT = { name = "Close Combat", type = "FIGHTING", category = "physical", power = 120, accuracy = 100, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerUserDefSpDef1" },
  COIL = { name = "Coil", type = "POISON", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAtkDefAcc1" },
  CONFIDE = { name = "Confide", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpAtk1" },
  COSMICPOWER = { name = "Cosmic Power", type = "PSYCHIC", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserDefSpDef1" },
  COTTONGUARD = { name = "Cotton Guard", type = "GRASS", category = "status", power = 0, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserDefense3" },
  COTTONSPORE = { name = "Cotton Spore", type = "GRASS", category = "status", power = 0, accuracy = 100, pp = 40, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpeed2" },
  ...
  CROSSPOISON = { name = "Cross Poison", type = "POISON", category = "physical", power = 70, accuracy = 100, pp = 20, priority = 0, highCrit = true, effect = "NO_ADDITIONAL_EFFECT", functionCode = "PoisonTarget" },
  CRUNCH = { name = "Crunch", type = "DARK", category = "physical", power = 80, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetDefense1" },
  ...
  DECORATE = { name = "Decorate", type = "FAIRY", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseTargetAtkSpAtk2" },
  ...
  DISCHARGE = { name = "Discharge", type = "ELECTRIC", category = "special", power = 80, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "ParalyzeTarget" },
  ...
  DRAGONBREATH = { name = "Dragon Breath", type = "DRAGON", category = "special", power = 60, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "ParalyzeTarget" },
  ...
  DRAGONDANCE = { name = "Dragon Dance", type = "DRAGON", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAtkSpd1" },
  ...
  DRAININGKISS = { name = "Draining Kiss", type = "FAIRY", category = "special", power = 50, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "HealUserByThreeQuartersOfDamageDone" },
  DRUMBEATING = { name = "Drum Beating", type = "GRASS", category = "physical", power = 80, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpeed1" },
  ...
  EERIEIMPULSE = { name = "Eerie Impulse", type = "ELECTRIC", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpAtk2" },
  ...
  ENERGYBALL = { name = "Energy Ball", type = "GRASS", category = "special", power = 90, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef1" },
  ...
  ETERNABEAM = { name = "Eternabeam", type = "DRAGON", category = "special", power = 160, accuracy = 90, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "AttackAndSkipNextTurn" },
  ...
  FAKETEARS = { name = "Fake Tears", type = "DARK", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef2" },
  ...
  FEINT = { name = "Feint", type = "NORMAL", category = "physical", power = 30, accuracy = 100, pp = 10, priority = 2, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RemoveProtections" },
  FIRELASH = { name = "Fire Lash", type = "FIRE", category = "physical", power = 80, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetDefense1" },
  ...
  FLAMECHARGE = { name = "Flame Charge", type = "FIRE", category = "physical", power = 50, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserSpeed1" },
  FLAMEWHEEL = { name = "Flame Wheel", type = "FIRE", category = "physical", power = 60, accuracy = 100, pp = 25, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "BurnTarget" },
  FLASHCANNON = { name = "Flash Cannon", type = "STEEL", category = "special", power = 80, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef1" },
  FLATTER = { name = "Flatter", type = "DARK", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseTargetSpAtk1ConfuseTarget" },
  ...
  GRAVAPPLE = { name = "Grav Apple", type = "GRASS", category = "physical", power = 80, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetDefense1PowersUpInGravity" },
  GUNKSHOT = { name = "Gunk Shot", type = "POISON", category = "physical", power = 120, accuracy = 80, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "PoisonTarget" },
  HAMMERARM = { name = "Hammer Arm", type = "FIGHTING", category = "physical", power = 100, accuracy = 90, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerUserSpeed1" },
  HEADSMASH = { name = "Head Smash", type = "ROCK", category = "physical", power = 150, accuracy = 80, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RecoilHalfOfDamageDealt" },
  ...
  HEALPULSE = { name = "Heal Pulse", type = "PSYCHIC", category = "status", power = 0, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "HealTargetHalfOfTotalHP" },
  ...
  HONECLAWS = { name = "Hone Claws", type = "DARK", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAtkAcc1" },
  ...
  INFERNO = { name = "Inferno", type = "FIRE", category = "special", power = 100, accuracy = 50, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "BurnTarget" },
  IRONDEFENSE = { name = "Iron Defense", type = "STEEL", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserDefense2" },
  ...
  LEAFSTORM = { name = "Leaf Storm", type = "GRASS", category = "special", power = 130, accuracy = 90, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerUserSpAtk2" },
  LEAFTORNADO = { name = "Leaf Tornado", type = "GRASS", category = "special", power = 65, accuracy = 90, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAccuracy1" },
  LIFEDEW = { name = "Life Dew", type = "WATER", category = "status", power = 0, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "HealUserAndAlliesQuarterOfTotalHP" },
  LIQUIDATION = { name = "Liquidation", type = "WATER", category = "physical", power = 85, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetDefense1" },
  LUNGE = { name = "Lunge", type = "BUG", category = "physical", power = 80, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAttack1" },
  ...
  METALBURST = { name = "Metal Burst", type = "STEEL", category = "physical", power = 1, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "CounterDamagePlusHalf" },
  METALCLAW = { name = "Metal Claw", type = "STEEL", category = "physical", power = 50, accuracy = 95, pp = 35, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAttack1" },
  METALSOUND = { name = "Metal Sound", type = "STEEL", category = "status", power = 0, accuracy = 85, pp = 40, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpDef2" },
  MIRRORCOAT = { name = "Mirror Coat", type = "PSYCHIC", category = "special", power = 1, accuracy = 100, pp = 20, priority = -5, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "CounterSpecialDamage" },
  ...
  NASTYPLOT = { name = "Nasty Plot", type = "DARK", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserSpAtk2" },
  NOBLEROAR = { name = "Noble Roar", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 30, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAtkSpAtk1" },
  NUZZLE = { name = "Nuzzle", type = "ELECTRIC", category = "physical", power = 20, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "ParalyzeTarget" },
  OUTRAGE = { name = "Outrage", type = "DRAGON", category = "physical", power = 120, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "MultiTurnAttackConfuseUserAtEnd" },
  ...
  PAINSPLIT = { name = "Pain Split", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "UserTargetAverageHP" },
  PLAYNICE = { name = "Play Nice", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAttack1BypassSubstitute" },
  PLAYROUGH = { name = "Play Rough", type = "FAIRY", category = "physical", power = 90, accuracy = 90, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAttack1" },
  ...
  POISONJAB = { name = "Poison Jab", type = "POISON", category = "physical", power = 80, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "PoisonTarget" },
  POISONTAIL = { name = "Poison Tail", type = "POISON", category = "physical", power = 50, accuracy = 100, pp = 25, priority = 0, highCrit = true, effect = "NO_ADDITIONAL_EFFECT", functionCode = "PoisonTarget" },
  ...
  POWERUPPUNCH = { name = "Power-Up Punch", type = "FIGHTING", category = "physical", power = 40, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAttack1" },
  ...
  PYROBALL = { name = "Pyro Ball", type = "FIRE", category = "physical", power = 120, accuracy = 90, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "BurnTarget" },
  ...
  RAZORSHELL = { name = "Razor Shell", type = "WATER", category = "physical", power = 75, accuracy = 95, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetDefense1" },
  ...
  ROCKPOLISH = { name = "Rock Polish", type = "ROCK", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserSpeed2" },
  ROCKSMASH = { name = "Rock Smash", type = "FIGHTING", category = "physical", power = 40, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetDefense1" },
  ROCKTOMB = { name = "Rock Tomb", type = "ROCK", category = "physical", power = 60, accuracy = 95, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpeed1" },
  ...
  SCARYFACE = { name = "Scary Face", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpeed2" },
  SHIFTGEAR = { name = "Shift Gear", type = "STEEL", category = "status", power = 0, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserAtk1Spd2" },
  ...
  SLUDGEBOMB = { name = "Sludge Bomb", type = "POISON", category = "special", power = 90, accuracy = 100, pp = 10, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "PoisonTarget" },
  ...
  SPARK = { name = "Spark", type = "ELECTRIC", category = "physical", power = 65, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "ParalyzeTarget" },
  SPIRITBREAK = { name = "Spirit Break", type = "FAIRY", category = "physical", power = 75, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpAtk1" },
  ...
  STEELWING = { name = "Steel Wing", type = "STEEL", category = "physical", power = 70, accuracy = 90, pp = 25, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseUserDefense1" },
  ...
  STRUGGLEBUG = { name = "Struggle Bug", type = "BUG", category = "special", power = 50, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpAtk1" },
  ...
  SUPERPOWER = { name = "Superpower", type = "FIGHTING", category = "physical", power = 120, accuracy = 100, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerUserAtkDef1" },
  SWAGGER = { name = "Swagger", type = "NORMAL", category = "status", power = 0, accuracy = 85, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RaiseTargetAttack2ConfuseTarget" },
  ...
  SWEETSCENT = { name = "Sweet Scent", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetEvasion2" },
  SYNTHESIS = { name = "Synthesis", type = "GRASS", category = "status", power = 0, accuracy = 100, pp = 5, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "HealUserDependingOnWeather" },
  TARSHOT = { name = "Tar Shot", type = "ROCK", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetSpeed1MakeTargetWeakerToFire" },
  TAUNT = { name = "Taunt", type = "DARK", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "DisableTargetStatusMoves" },
  TEARFULLOOK = { name = "Tearful Look", type = "NORMAL", category = "status", power = 0, accuracy = 100, pp = 20, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "LowerTargetAtkSpAtk1" },
  TORMENT = { name = "Torment", type = "DARK", category = "status", power = 0, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "DisableTargetUsingSameMoveConsecutively" },
  ...
  WOODHAMMER = { name = "Wood Hammer", type = "GRASS", category = "physical", power = 120, accuracy = 100, pp = 15, priority = 0, highCrit = false, effect = "NO_ADDITIONAL_EFFECT", functionCode = "RecoilThirdOfDamageDealt" },
}
